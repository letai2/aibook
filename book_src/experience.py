...
def residual_diagram():
    return '''<figure class="residual-diagram"><svg class="residual-desktop" viewBox="0 0 760 310" role="img" aria-labelledby="residual-title residual-desc"><title id="residual-title">دو مسیر جمع در بلوک پیش‌نرمال</title><desc id="residual-desc">ورودی به نرمال‌سازی و توجه می‌رود و همچنین مستقیم به جمع اول. نتیجه به نرمال‌سازی و پیش‌خور و نیز مستقیم به جمع دوم می‌رود.</desc>
...
<div class="matrix-pair"><div><h3>امتیاز مقیاس‌شده · QKᵀ / √2</h3><div data-attention-scores></div></div><div><h3>وزن پس از پوشش و softmax</h3><div data-attention-weights></div></div></div><p class="readout" data-attention-result aria-live="polite"></p><p class="meta">«پرسش/کلید/مقدار» نام سه تبدیل آموخته است، نه سه نوع کلمه. خانهٔ ممنوع پیش از softmax برابر منفی بی‌نهایت می‌شود؛ صفرکردن امتیاز کافی نیست.</p></section>'''
