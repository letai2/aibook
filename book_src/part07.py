...
<div class="flow">متن → نشانه‌بندی → شناسه‌ها → بردار نشانه + بردار موقعیت → بلوک‌های Transformer → نرمال‌سازی نهایی → امتیازها → احتمال‌ها → شناسهٔ انتخاب‌شده → متن ادامه‌یافته</div>
